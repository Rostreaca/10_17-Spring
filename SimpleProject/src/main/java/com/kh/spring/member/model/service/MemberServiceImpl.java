...
//		
//		if(loginMember ==null) {
//			throw new UserIdNotFoundException("아이디 또는 비밀번호를 잘못 입력하였습니다.");
//		}
//		
//		// 1절
...
//		return null;
	...
	public void update(MemberDTO member, HttpSession session) {
		...
		// (EMAIL 컬럼에 넣을 값이 실제 EMAIL형식과 일치하는가?)
		// DB가서 UPDATE
	...
	public void delete(String userPwd, HttpSession session) {
		 ...
		 * 세팅 수업시간에 있던거 다 쓰기
		 * 
		 * 스프링을 이용한 기능 구현 ==> 숙제(주말까지)==> 꼭!! 하기
		 * 
		 * 앞에서 구현헀던
		 * DynamicWebProject 회원파트 ==> Spring버전으로 다시 만들기
		 * 
		 *  화면 다있음 테이블 다 있음 SQL문 다 있음 ==> Service단 및 예외처리을 신경써보자
		 * 
		 */		
